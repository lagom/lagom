...
object Dependencies {
  object Versions {
    ...
    val HibernateCore = "5.4.22.Final"
  ...
  private val dropwizardMetricsCore = ("io.dropwizard.metrics" % "metrics-core" % "4.1.15").excludeAll(excludeSlf4j: _*)
