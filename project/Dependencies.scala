...
object Dependencies {
  object Versions {
    ...
    val HibernateCore = "5.4.28.Final"
  ...
  private val scalaCollectionCompat  = "org.scala-lang.modules" %% "scala-collection-compat" % "2.4.1"
  ...
  private val dropwizardMetricsCore = ("io.dropwizard.metrics" % "metrics-core" % "4.1.19").excludeAll(excludeSlf4j: _*)
  ...
  private val mockitoCore = "org.mockito" % "mockito-core" % "3.7.7"
