...
object Dependencies {
  object Versions {
    ...
    val Akka: String = sys.props.getOrElse("lagom.build.akka.version", "2.6.1") // sync with docs/build.sbt
    val AkkaHttp     = "10.1.11"

    val AkkaPersistenceCassandra = "0.101"
  ...
  private val dropwizardMetricsCore = ("io.dropwizard.metrics" % "metrics-core" % "4.1.2").excludeAll(excludeSlf4j: _*)
