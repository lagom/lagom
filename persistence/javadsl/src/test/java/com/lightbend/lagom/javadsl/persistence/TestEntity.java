...
//        }
    ...
    private Behavior becomeAppending(Behavior current) {
        ...
        b.setCommandHandler(Add.class, (Add cmd, CommandContext ctx) -> {
    ...
    private Behavior becomePrepending(Behavior current) {
        ...
        b.setCommandHandler(Add.class,
                (Add cmd, CommandContext ctx) -> ctx.thenPersist(new Prepended(cmd.element.toLowerCase()), evt -> ctx.reply(evt)));
        return b.build();
    }
