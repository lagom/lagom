...
> **Note**: [Akka style guide](https://doc.akka.io/docs/akka/2.6/typed/style-guide.html?language=Scala) recommends having an `apply` factory method in the companion object and making the constructor private.
