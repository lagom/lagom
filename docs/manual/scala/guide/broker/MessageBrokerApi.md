...
There are also `andMetadata` methods on [`TopicProducer`](api/com/lightbend/lagom/scaladsl/broker/TopicProducer$.html) that provide possibility to create [`Message`](api/com/lightbend/lagom/scaladsl/broker/api/Message$.html) with metadata.
