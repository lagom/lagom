...
lazy val `build-tool-support` = (project in file("dev") / "build-tool-support")
  ...
  .settings(
    ...
    crossScalaVersions := Seq(Dependencies.Versions.ScalaVersions.head),
    scalaVersion := Dependencies.Versions.ScalaVersions.head,
    crossPaths := false,
...
lazy val `sbt-build-tool-support` = (project in file("dev") / "build-tool-support")
  ...
  .settings(
    ...
    crossScalaVersions := Dependencies.Versions.SbtScalaVersions,
    scalaVersion := Dependencies.Versions.SbtScalaVersions.head,
  ...
  .settings(
    ...
    libraryDependencies ++= Seq(
      Defaults.sbtPluginExtra(
        "com.typesafe.play" % "sbt-plugin" % Dependencies.Versions.PlayVersion,
        ...
        val lagomDeps = Def.settingDyn {
          ...
          (javadslProjects ++ coreProjects).map { project =>
            Def.setting {
              ...
              Dependencies.Versions.ScalaVersions.map { supportedVersion =>
