 ...
 *
 * <p>This interface implements a DSL for describing a service. It is inherently constrained in its
 * use.
 *
 * <p>A service can describe itself by defining an interface that extends this interface, and
 * provides a default implementation for the {@link #descriptor()} method.
 */
public interface Service {
   ...
   *
   * <p>The intended mechanism for implementing this is to provide it as a default implementation on
   * an interface.
   */
   ...
   */
  static <Request, Response> Descriptor.Call<Request, Response> restCall(
      Method method, String pathPattern, Creator<ServiceCall<Request, Response>> methodRef) {
   ...
   * @return A REST service call descriptor.
   */
  static <Request, Response, A> Descriptor.Call<Request, Response> restCall(
      Method method, String pathPattern, Function<A, ServiceCall<Request, Response>> methodRef) {
    return call(new Descriptor.RestCallId(method, pathPattern), methodRef);
  }
   ...
   * @return A REST service call descriptor.
   */
  static <Request, Response, A, B> Descriptor.Call<Request, Response> restCall(
      Method method,
      String pathPattern,
   ...
   * @return A REST service call descriptor.
   */
  static <Request, Response, A, B, C> Descriptor.Call<Request, Response> restCall(
      Method method,
      String pathPattern,
   ...
   * @return A REST service call descriptor.
   */
  static <Request, Response, A, B, C, D> Descriptor.Call<Request, Response> restCall(
      Method method,
      String pathPattern,
   ...
   * @return A REST service call descriptor.
   */
  static <Request, Response, A, B, C, D, E> Descriptor.Call<Request, Response> restCall(
      Method method,
      String pathPattern,
   ...
   * @return A REST service call descriptor.
   */
  static <Request, Response, A, B, C, D, E, F> Descriptor.Call<Request, Response> restCall(
      Method method,
      String pathPattern,
   ...
   * @return A REST service call descriptor.
   */
  static <Request, Response, A, B, C, D, E, F, G> Descriptor.Call<Request, Response> restCall(
      Method method,
      String pathPattern,
   ...
   * @return A REST service call descriptor.
   */
  static <Request, Response, A, B, C, D, E, F, G, H> Descriptor.Call<Request, Response> restCall(
      Method method,
      String pathPattern,
   ...
   * @return A REST service call descriptor.
   */
  static <Request, Response, A, B, C, D, E, F, G, H, I> Descriptor.Call<Request, Response> restCall(
      Method method,
      String pathPattern,
  ...
  static <Request, Response, A, B, C, D, E, F, G, H, I, J>
      Descriptor.Call<Request, Response> restCall(
          Method method,
          String pathPattern,
   ...
   */
  static <Request, Response> Descriptor.Call<Request, Response> restCall(
      Method method, String pathPattern, java.lang.reflect.Method methodRef) {
    return call(new Descriptor.RestCallId(method, pathPattern), methodRef);
  }
   ...
   */
  static <Request, Response> Descriptor.Call<Request, Response> pathCall(
   ...
   * @return A path identified service call descriptor.
   */
  static <Request, Response, A> Descriptor.Call<Request, Response> pathCall(
   ...
   * @return A path identified service call descriptor.
   */
  static <Request, Response, A, B> Descriptor.Call<Request, Response> pathCall(
   ...
   * @return A path identified service call descriptor.
   */
  static <Request, Response, A, B, C> Descriptor.Call<Request, Response> pathCall(
   ...
   * @return A path identified service call descriptor.
   */
  static <Request, Response, A, B, C, D> Descriptor.Call<Request, Response> pathCall(
   ...
   * @return A path identified service call descriptor.
   */
  static <Request, Response, A, B, C, D, E> Descriptor.Call<Request, Response> pathCall(
   ...
   * @return A path identified service call descriptor.
   */
  static <Request, Response, A, B, C, D, E, F> Descriptor.Call<Request, Response> pathCall(
   ...
   * @return A path identified service call descriptor.
   */
  static <Request, Response, A, B, C, D, E, F, G> Descriptor.Call<Request, Response> pathCall(
      String pathPattern,
      Function7<A, B, C, D, E, F, G, ServiceCall<Request, Response>> methodRef) {
    return call(new Descriptor.PathCallId(pathPattern), methodRef);
  }
   ...
   * @return A path identified service call descriptor.
   */
  static <Request, Response, A, B, C, D, E, F, G, H> Descriptor.Call<Request, Response> pathCall(
      String pathPattern,
      Function8<A, B, C, D, E, F, G, H, ServiceCall<Request, Response>> methodRef) {
    return call(new Descriptor.PathCallId(pathPattern), methodRef);
  }
   ...
   * @return A path identified service call descriptor.
   */
  static <Request, Response, A, B, C, D, E, F, G, H, I> Descriptor.Call<Request, Response> pathCall(
      String pathPattern,
      Function9<A, B, C, D, E, F, G, H, I, ServiceCall<Request, Response>> methodRef) {
    return call(new Descriptor.PathCallId(pathPattern), methodRef);
  }
   ...
   */
  static <Request, Response, A, B, C, D, E, F, G, H, I, J>
      Descriptor.Call<Request, Response> pathCall(
          String pathPattern,
          Function10<A, B, C, D, E, F, G, H, I, J, ServiceCall<Request, Response>> methodRef) {
    return call(new Descriptor.PathCallId(pathPattern), methodRef);
  }
   ...
   */
  static <Request, Response> Descriptor.Call<Request, Response> namedCall(
      String name, Creator<ServiceCall<Request, Response>> methodRef) {
   ...
   */
  static <Request, Response> Descriptor.Call<Request, Response> namedCall(
      String name, java.lang.reflect.Method methodRef) {
    return call(new Descriptor.NamedCallId(name), methodRef);
  }
   ...
   *
   * <p>The identifier for this descriptor will be automatically selected by Lagom.
   *
   * @param methodRef The service call.
   * @return A name identified service call descriptor.
   */
   ...
   */
  static <Request, Response> Descriptor.Call<Request, Response> call(
      Descriptor.CallId callId, Object methodRef) {
    return new Descriptor.Call<>(
        callId,
        new MethodRefServiceCallHolder(methodRef),
   ...
   */
  static <Message> Descriptor.TopicCall<Message> topic(
      String topicId, java.lang.reflect.Method methodRef) {
   ...
   */
  static <Message> Descriptor.TopicCall<Message> topic(
      String topicId, Creator<Topic<Message>> methodRef) {
    return topic(topicId, (Object) methodRef);
  }
  ...
  static <Message> Descriptor.TopicCall<Message> topic(String topicId, Object methodRef) {
    return new Descriptor.TopicCall<>(
        TopicId.of(topicId),
        new MethodRefTopicHolder(methodRef),
        new MethodRefMessageSerializer<>(),
        new Descriptor.Properties<>(HashTreePMap.empty()));
  }
}
