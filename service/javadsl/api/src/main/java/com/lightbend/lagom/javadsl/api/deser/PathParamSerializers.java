...
public final class PathParamSerializers {
  ...
  public static <Param> PathParamSerializer<Param> required(
      String name, Function<String, Param> deserialize, Function<Param, String> serialize) {
  ...
  public static <Param> PathParamSerializer<Optional<Param>> optional(
      String name, Function<String, Param> deserialize, Function<Param, String> serialize) {
    ...
    return new NamedPathParamSerializer<Optional<Param>>("Optional(" + name + ")") {
      ...
      public PSequence<String> serialize(Optional<Param> parameter) {
        return parameter
            .map(p -> TreePVector.singleton(serialize.apply(p)))
  ...
  private static <Param> Stream<String> serializeCollection(
      Collection<Param> parameter, Function<Param, PSequence<String>> serialize) {
    return parameter.stream().flatMap(s -> serialize.apply(s).stream());
  }

  private static <Param> Stream<Param> deserializeCollection(
      PSequence<String> parameters, Function<PSequence<String>, Param> deserialize) {
    return parameters.stream().map(s -> deserialize.apply(TreePVector.singleton(s)));
  }

  /** Create a PathParamSerializer for List parameters. */
  public static <Param> PathParamSerializer<List<Param>> list(
      String name,
    ...
    return new NamedPathParamSerializer<List<Param>>("List(" + name + ")") {
      ...
      public PSequence<String> serialize(List<Param> parameter) {
        List<String> serializedParams =
            serializeCollection(parameter, serialize).collect(Collectors.toList());
  ...
  public static <Param> PathParamSerializer<Set<Param>> set(
      String name,
      Function<PSequence<String>, Param> deserialize,
      Function<Param, PSequence<String>> serialize) {
    ...
    return new NamedPathParamSerializer<Set<Param>>("Set(" + name + ")") {
      ...
      public PSequence<String> serialize(Set<Param> parameter) {
        Set<String> serializedParams =
            serializeCollection(parameter, serialize).collect(Collectors.toSet());
        return TreePVector.from(serializedParams);
      }
  ...
  public static <Param> PathParamSerializer<Collection<Param>> collection(
      String name,
      Function<PSequence<String>, Param> deserialize,
      Function<Param, PSequence<String>> serialize) {
  ...
  public static final PathParamSerializer<String> STRING =
      required("String", Function.identity(), Function.identity());

  /** A Long path param serializer. */
  public static final PathParamSerializer<Long> LONG =
      required("Long", Long::parseLong, l -> l.toString());

  /** An Integer path param serializer. */
  public static final PathParamSerializer<Integer> INTEGER =
      required("Integer", Integer::parseInt, i -> i.toString());

  /** An Double path param serializer. */
  public static final PathParamSerializer<Double> DOUBLE =
      required("Double", Double::parseDouble, d -> d.toString());

  /** A Boolean path param serializer. */
  public static final PathParamSerializer<Boolean> BOOLEAN =
      required("Boolean", Boolean::parseBoolean, b -> b.toString());

  /** A UUID path param serializer. */
  public static final PathParamSerializer<UUID> UUID =
      required("UUID", java.util.UUID::fromString, u -> u.toString());

  /** A generic (unresolved) Optional serializer. */
  public static final PathParamSerializer<Optional<Object>> OPTIONAL =
      new UnresolvedOptionalPathParamSerializer<>();

  /** A generic (unresolved) List serializer. */
  public static final PathParamSerializer<java.util.List<Object>> LIST =
      new UnresolvedListPathParamSerializer<>();

  /** A generic (unresolved) Set serializer. */
  public static final PathParamSerializer<java.util.Set<Object>> SET =
      new UnresolvedSetPathParamSerializer<>();

  /** A generic (unresolved) Collection serializer. */
  public static final PathParamSerializer<java.util.Collection<Object>> COLLECTION =
      new UnresolvedCollectionPathParamSerializer<>();

  private abstract static class NamedPathParamSerializer<Param>
