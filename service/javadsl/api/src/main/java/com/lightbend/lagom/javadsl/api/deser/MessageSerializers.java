...
public class MessageSerializers {
  ...
  public static final StrictMessageSerializer<NotUsed> NOT_USED =
      new StrictMessageSerializer<NotUsed>() {
        ...
        @Override
        public NegotiatedDeserializer<NotUsed, ByteString> deserializer(
            MessageProtocol messageProtocol) throws SerializationException {
          return bytes -> NotUsed.getInstance();
        }

        @Override
        public NegotiatedSerializer<NotUsed, ByteString> serializerForResponse(
  ...
  public static final StrictMessageSerializer<String> STRING =
      new StrictMessageSerializer<String>() {
