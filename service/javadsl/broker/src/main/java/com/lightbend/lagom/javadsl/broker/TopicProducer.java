...
public final class TopicProducer {
   ...
   */
  public static <Payload> Topic<Payload> singleStreamWithOffsetAndMetadata(
      Function<Offset, Source<Pair<Message<Payload>, Offset>, ?>> eventStream) {
    return taggedStreamWithOffsetAndMetadata(
        SINGLETON_TAG, (tag, offset) -> eventStream.apply(offset));
  }
   ...
   * @return The topic producer.
   */
  public static <Payload, Event extends AggregateEvent<Event>>
      Topic<Payload> taggedStreamWithOffsetAndMetadata(
          PSequence<AggregateEventTag<Event>> tags,
          BiFunction<AggregateEventTag<Event>, Offset, Source<Pair<Message<Payload>, Offset>, ?>>
              eventStream) {
    return TaggedOffsetTopicProducer.withMetadata(tags, eventStream);
  }
  ...
  public static <Payload, Event extends AggregateEvent<Event>>
      Topic<Payload> taggedStreamWithOffsetAndMetadata(
          ...
          BiFunction<AggregateEventTag<Event>, Offset, Source<Pair<Message<Payload>, Offset>, ?>>
              eventStream) {
    return TaggedOffsetTopicProducer.withMetadata(shards.allTags(), eventStream);
  }
   ...
   * @return The topic producer.
   */
  public static <Payload> Topic<Payload> singleStreamWithOffset(
      Function<Offset, Source<Pair<Payload, Offset>, ?>> eventStream) {
   ...
   */
  public static <Payload, Event extends AggregateEvent<Event>>
      Topic<Payload> taggedStreamWithOffset(
          PSequence<AggregateEventTag<Event>> tags,
          BiFunction<AggregateEventTag<Event>, Offset, Source<Pair<Payload, Offset>, ?>>
              eventStream) {
    return TaggedOffsetTopicProducer.withoutMetadata(tags, eventStream);
  }
  ...
  public static <Payload, Event extends AggregateEvent<Event>>
      Topic<Payload> taggedStreamWithOffset(
          ...
          BiFunction<AggregateEventTag<Event>, Offset, Source<Pair<Payload, Offset>, ?>>
              eventStream) {
    return TaggedOffsetTopicProducer.withoutMetadata(shards.allTags(), eventStream);
  }
}
