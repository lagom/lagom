...
final class TaggedOffsetTopicProducer[Payload, Event <: AggregateEvent[Event]](
    ...
    val readSideStream: (AggregateEventTag[Event], Offset) => Source[(Message[Payload], Offset), _]
...
object TaggedOffsetTopicProducer {
  ...
  def apply[Payload, Event <: AggregateEvent[Event]](
      ...
      readSideStream: (AggregateEventTag[Event], Offset) => Source[(Message[Payload], Offset), _]
