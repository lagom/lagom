...
private[lagom] object Servers {
  ...
  private[lagom] object KafkaServer extends ServerContainer {
    ...
    def start(log: LoggerProxy, cp: Seq[File], kafkaPort: Int, zooKeeperPort: Int, kafkaPropertiesFile: Option[File], jvmOptions: Seq[String], targetDir: File, cleanOnStart: Boolean): Unit = {
