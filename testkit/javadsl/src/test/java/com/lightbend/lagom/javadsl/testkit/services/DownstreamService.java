...
public interface DownstreamService extends Service {
  ...
  class Impl implements DownstreamService {
    ...
    private final ConcurrentLinkedQueue<ReceivedMessage> receivedMessagesC =
        new ConcurrentLinkedQueue<>();
    private final ConcurrentLinkedQueue<ReceivedMessage> receivedMessagesF =
        new ConcurrentLinkedQueue<>();
    private final ConcurrentLinkedQueue<ReceivedMessage> receivedMessagesD =
        new ConcurrentLinkedQueue<>();
